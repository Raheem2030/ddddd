              ...
              {content?.quizzes && content.quizzes.length > 0 ? (
                content.quizzes.map((quiz) => (
                  <div 
                    ...
                    className="glass-panel rounded-2xl p-5 border border-white/10 flex items-center justify-between hover:border-[var(--color-pharma-accent)]/50 transition-colors cursor-pointer"
                  >
